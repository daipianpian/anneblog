...
<script type="text/ecmascript-6">
	import {typeEditType, typeUpdateType} from "../../../config/interface.js"
	export default {
        props: {
        },
        data() {
		...
		methods: {
			...
			editClassify() {
				const url = typeEditType
	            const _this = this
				let params = {
					typeId: this.formDatas.id
				}
				fetch(url,params)
				.then(res =>{
					if(res.code == 10000){
